    ...
    private class DownloadTask extends AsyncTask<String, Integer, DownloadTask.Result> {
        ...
        private String downloadUrl(URL url) throws IOException {
            ...
            try {
                ...
                // set ssl protocal
//                try {
//                    SSLSocketFactory sslsocketfactory = getSSLSocketFactory("TLS");
//                    connection.setSSLSocketFactory(sslsocketfactory);
//                    Log.d("SSL-PTL:", "Set protocal successfully!");
//                } catch( Exception e ) {
//                    Log.d("SSL-PTL:", e.getMessage());
//                }
        ...
        public SSLSocketFactory getSSLSocketFactory(String protocal)
            throws Exception {
